# -*- coding: utf-8 -*-
"""kada-kim-resnet.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/16Tp6Zs9wxgoM6mvYj6VOcUrqV5RxOoOR

* Version 1 : 5 models valid score: 2227.345577419398	auc_score: 0.5540	logloss_score:4.0700  
* Version 2 : EARLYSTOP_NUM = 10  5 models valid score: 2138.9704583178773	auc_score: 0.5553	logloss_score:4.0698   
  - BATCH_SIZE = 4096
  - Train Data ~ 500
"""
...
if TRAIN:
    train = train.loc[train.date > 0].reset_index(drop=True)
